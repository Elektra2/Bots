...
dateFrom = dateTo - timedelta(days=28)
  ...
  try:
    ...
    while True:
      ...
      try:
        ...
        response = requests.post("https://api-seller.ozon.ru/v2/posting/fbs/list", headers=headers, data=body)
        ...
        for list_data in response:
          ...
          delivery_method_name += [0]
          delivery_method_warehouse_id += [0]
          delivery_method_warehouse += [0]
          delivery_method_tpl_provider_id += [0]
          delivery_method_tpl_provider += [0]
        ...
        print(197, len(products_0_price))
        data = pd.DataFrame({
          'order_id':order_id,
          ...
          'delivery_method_warehouse_id':delivery_method_warehouse_id,
          'delivery_method_warehouse':delivery_method_warehouse,
          'delivery_method_tpl_provider_id':delivery_method_tpl_provider_id,
          'delivery_method_tpl_provider':delivery_method_tpl_provider,
    ...
    if data.at[0, 'user_id'] == sheet_id:
      ...
      try:
        ...
        data.to_sql('posting_fbs_list_ozon', engine, if_exists='append')
        data.to_sql('posting_fbs_list_ozon_all', engine, if_exists='append')
